...
<body>
    ...
    <main>
        <div class="info_teacher">
            <h1>ИНОРМАЦИЯ ДЛЯ АБИТУРИЕНТОВ </h1>
            <h2>СПЕЦИАЛЬНОСТИ</h2>
            <div class="cards1">
                <p>09.01.03 Мастер по обработке цифровой информации</p>
                <p>09.02.01 Компьютерные системы и комплексы</p>
                <p>09.02.06 Сетевое и системное администрирование</p>
                <p>09.02.07 Информационные системы и программирование (с присвоением квалификации «специалист по информационным системам»)</p>
                <p>54.01.20 Графический дизайнер</p>
                <p>11.02.01 Радиоаппаратостроение</p>
                <p>11.02.02 Техническое обслуживание и ремонт радиоэлектронной техники (по отраслям)</p>   
            </div>       
        </div>
    </main>
    <footer>
